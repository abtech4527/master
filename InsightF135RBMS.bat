...
start /wait msiexec.exe /i "\\ADM-VM-DC01\Shares\Software$\InsightStudentSetup.msi" /qb CMDLINE="/classId Class101 
 /hideSysTrayIcon /adminPwd Password123 /installBrowserExtension /enableWebHistory"
