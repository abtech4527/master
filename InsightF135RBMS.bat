...
start /wait msiexec.exe /i "//ADM-VM-DC01\Shares\Software$\InsightStudentSetup.msi" /qn CMDLINE="/classId Class135 /adminPwd Password123 /installBrowserExtension /enableWebHistory /sharedSecret Password345 /suppressreboot"
NET USE Z: /delete
